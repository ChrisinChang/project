...
<div id="search" class="box hide">
 ...
 <div id="bd" class="box">
  <div id="toolbar">
    <a href="{{url('admin/links/create')}}" class="btn btn-primary btn-sm">新增</a>
  </div>
  <div id="content">
    <table width="100%" border="0" cellspacing="1" cellpadding="4" class="listT">
      ...
      @if(count($data) > 0)
        ...
        <tr align="center" class="listT_row01">
          ...
          <td><a href="{{url('admin/links/'.$v->id.'/edit')}}" class="fa fa-2x fa-edit text-info"></a></td>
  ...
  <script>
      ...
      function changeOrder(obj,id) {
          var sort = $(obj).val();
          $.post("{{url('admin/links/changesort')}}",{'_token':'{{csrf_token()}}','id':id,'sort':sort},function(data){
              if(data.status == 0){
