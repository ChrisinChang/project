...
@section('content')
<!-- 位置 -->
<div id="position" class="dark_blue15">網站資料設定 &gt; 新增內容</div>
<!-- 顯示內容 -->
<div id="bd" class="box">
<!--div id="toolbar">
...
<div id="content">
  ...
  <table width="95%" border="0" cellspacing="1" cellpadding="4" align="center" class="formT">
    <tr>
      ...
      <td width="80%" class="formT_row"><input type="text" class="size-6 form-control" name="title" value="" /></td>
    </tr>
    <tr class="">
      <td width="20%" class="formT_field"> * 名　　稱</td>
      <td width="80%" class="formT_row"><input type="text" class="size-6 form-control" name="name" id="name" value="" /></td>
    </tr>
    <tr class="">
    ...
    <tr class="field_value">
      <td width="20%" class="formT_field"> * 類　　型</td>
      <td width="80%" class="formT_row">
        <input type="text" class="size-6 form-control " name="field_value" >
        <p><i class="fa fa-exclamation-circle yellow"></i>只有radio的情況下才須設定，格式 1|開啟, 0|關閉</p>
      </td>
    </tr>
    <tr class="">
      <td width="20%" class="formT_field">說　　明</td>
      <td width="80%" class="formT_row"><textarea class="form-control" cols="50" rows="8" name="memo"></textarea></td>
    </tr>
    <tr class="">
      <td width="20%" class="formT_field"> * 排　　序</td>
      <td width="80%" class="formT_row"><input type="number" class="size-1 form-control" name="sort" min="0" value="0" /></td>
    </tr>
    <tr>
